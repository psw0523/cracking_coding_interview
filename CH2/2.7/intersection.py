...
if __name__ == '__main__':
    ...
    node = Node('e')
    linked_list.add('a').add('b').add('c').add('b').add('a').add_node(node)
    print(linked_list)

    my_list = LinkedList().add('a').add('b').add('c').add('c').add('b').add('a').add('a').add_node(node)
    print(my_list)

    print(linked_list.intersect(my_list))
