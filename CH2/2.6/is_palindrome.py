...
if __name__ == '__main__':
    ...
    linked_list.add('a').add('b').add('c').add('b').add('a')
    print(linked_list)
    print("palindrome? ", linked_list.is_palindrome())
    my_list = LinkedList().add('a').add('b').add('c').add('c').add('b').add('a').add('a')
    print(my_list)
    print("palindrome? ", my_list.is_palindrome())
